...
export default function SmallHeader() {
  ...
  return (
    <header className="flex items-center align-middle text-center my-12 md:my-16 -translate-x-4">
      <div>
        <button
          className={imgVis}
          onClick={() => {
        ...
        >
          <img
            ...
            className="w-18 md:w-20 object-contain hover:scale-110 hover:rotate-3 active:scale-100 active:rotate-0 transition-all cursor-pointer"
          />
        </button>
        <button
          className={svgVis}
      ...
      <div className="text-left ml-2">
        <Link
          href="/"
          className="text-2xl md:text-3xl font-bold max-w-min hover:text-gray-600 active:text-gray-500 transition-all mx-auto cursor-pointer"
        >
          JakeO.dev
        </Link>
