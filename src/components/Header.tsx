...
export default function Header() {
  ...
  return (
    <header className="flex items-center align-middle text-center my-14 md:my-20 -translate-x-4">
      <div>
        <button
          className={imgVis}
          onClick={() => {
      ...
      {/* <div className="border-l-[2.5px] border-dotted border-gray-300 mx-6 h-24"></div> */}
