          ...
          <div className="mr-auto -ml-1 flex items-center justify-center gap-2.5 sm:absolute sm:left-0 sm:-ml-0 sm:gap-4">
            ...
            <div className="relative h-min">
              <button
                ...
                className="flex cursor-pointer text-base text-stone-500 transition hover:scale-110 hover:text-sky-500 active:scale-100"
            ...
            <a
              ...
              className="flex h-min text-base text-stone-500 transition hover:scale-110 hover:text-stone-700 active:scale-100"
            >
              {width >= 640 ? (
                "github"
              ) : (
            ...
            <div className="relative h-min">
              <button
                ...
                className="flex cursor-pointer text-base text-stone-500 transition hover:scale-110 hover:text-indigo-500 active:scale-100"
