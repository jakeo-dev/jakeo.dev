export default function Contents(props: { subtitles: string[] }) {
  return (
    <div className="top-6 flex-[0.35] self-start lg:sticky lg:block xl:w-0 xl:flex-[0]">
      ...
      <div className="mb-16 grid grid-cols-3 gap-x-6 gap-y-2 md:grid-cols-4 lg:mt-6 lg:-mr-20 lg:ml-10 lg:block lg:rounded-lg lg:bg-gray-200/70 lg:p-5 xl:-mr-60 2xl:-mr-80">
