export default function Contents(props: { subtitles: string[] }) {
  return (
    <div className="top-6 flex-[0.35] self-start lg:sticky lg:block xl:w-0 xl:flex-[0]">
      ...
      <div className="mb-16 grid grid-cols-2 gap-x-6 gap-y-3 sm:grid-cols-3 md:grid-cols-4 lg:mt-6 lg:-mr-20 lg:ml-10 lg:block lg:rounded-lg lg:bg-stone-200/60 lg:p-5 xl:-mr-60 2xl:-mr-80">
        ...
        {props.subtitles.map((subtitle, index) => (
          <a
            ...
            href={`#${subtitle
              ...
              .replace(/[^a-zA-Z0-9-]/g, "")
              .toLowerCase()}`}
            className="text internal-link block leading-6 no-underline mb-0 lg:mb-4 last:lg:mb-0"
          >
            {subtitle}
          </a>
        ))}
