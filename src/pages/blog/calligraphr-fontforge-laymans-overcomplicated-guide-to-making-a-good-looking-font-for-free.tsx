        ...
        <div className="flex-1">
          <Paper speed="off">
            <p className="text">
              ...
              . Calligraphr is a great service that lets you create your own
              font, but it's really only useful if you upgrade to the Pro
              version. So instead of spending $4 a month, you can do what I did
              as an amateur at typeface design, and spend a little more time in
              FontForge to make a good-looking font.
            </p>
            {/* <p className="text">
            ...
            <p className="text">
              Here are links to the various websites/apps we'll use to create
              the font:
            </p>
          ...
          <Paper
            ...
            id="beginning-with-calligraphr"
          >
            <h2>Beginning with Calligraphr</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
            ...
            <p className="text">
              Click Download Template at the top of the page. I recommend
              enabling "Draw helplines" and "Characters as background" to help
              with drawing the characters. Setting the file format to PNG
              instead of PDF may also make it easier if you plan to use image
              editing software. Click Download to download the font template
              file(s).
            </p>
          </Paper>
          ...
          <Paper speed="off">
            ...
            <ul className="text list-disc pl-6 md:pl-10">
              ...
              <li className="text">
                ...
                found that drawing the characters on the computer using a
                drawing tablet makes the font turn out much cleaner.
              </li>
            </ul>
          </Paper>
          ...
          <Paper
            speed="slow"
            className="sub1title w-fit"
            id="downloading-from-calligraphr"
          >
            <h2>Downloading from Calligraphr</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper
            speed="slow"
            className="sub1title w-fit"
            id="uploading-to-fontforge"
          >
            <h2>Uploading to FontForge</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub1title w-fit" id="merging-fonts">
            <h2>Merging Fonts</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper
            speed="slow"
            className="sub1title w-fit"
            id="making-transformations"
          >
            <h2>Making Transformations</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper
            speed="slow"
            className="sub1title w-fit"
            id="making-precise-adjustments"
          >
            <h2>Making Precise Adjustments</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
              You may still have some glyphs that don't look quite right, even
              after scaling, moving, or rotating. Luckily, FontForge allows us
          ...
          <div className="post-img-div">
            <Paper className="relative mb-2" padding="none" speed="off">
              <Image
          ...
          <Paper speed="slow" className="sub1title w-fit" id="kerning">
            <h2>Kerning</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <div className="post-img-div flex gap-x-2">
            <div>
              <Paper padding="none" speed="off">
                <Image
          ...
          <Paper speed="off">
            <p className="text">
              FontForge has a useful tool that can automatically kern your font.
              I followed{" "}
              <a
                className="link"
              ...
              to autokern my own font, and I'll use the steps there to explain
              how to do it here.
            </p>
            <p className="text">
          ...
          <Paper
            speed="slow"
            className="sub1title w-fit"
            id="previewing-in-fontforge"
          >
            <h2>Previewing in FontForge</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub1title w-fit" id="fixing-errors">
            <h2>Fixing Errors</h2>
          </Paper>
          {/* <p className="text">
          ...
          <Paper speed="off">
            <p className="text">
              There are a few common errors that FontForge will throw when
              trying to download a font. To ensure the best appearance and
              compatibility on all devices, you'll have to fix these errors.
            </p>
            <p className="subtext">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Fixing Em Size (for TrueType)</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Fixing "Missing Points at Extrema"</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Fixing "Self Intersecting"</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Fixing "Non-Integral Coordinates"</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper
            speed="slow"
            className="sub1title w-fit"
            id="generating-the-final-font"
          >
            <h2>Generating the Final Font</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub1title w-fit" id="now-what">
            <h2>Now What?</h2>
          </Paper>
