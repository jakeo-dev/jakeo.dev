        ...
        <div className="lg:flex lg:flex-row-reverse">
          ...
          <div className="flex-1">
            ...
            <Callout>
              ...
              other method to decide which characters are included in the font
              if you have more than 75. Just delete the ones that were included
              in the first font file.
            </Callout>
            <p className="text">
