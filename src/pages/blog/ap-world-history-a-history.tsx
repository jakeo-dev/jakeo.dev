      ...
      <div className="lg:flex lg:flex-row-reverse">
        ...
        <div className="flex-1">
          <p className="text">
            ...
            either to more accurately represent college-level classes or to make
            ...
            <li className="text">
              ...
              <table className="sp-table -ml-6 md:-ml-10 mt-4">
                ...
                <tbody className="sp-table-row">
                  <tr>
                    <td className="sp-table-item">
                      Groups documents in 1, 2, or 3 different ways depending on
                      the prompt
                    </td>
                    <td className="sp-table-item">1</td>
                  </tr>
                ...
                <tbody className="sp-table-row">
                  <tr>
                    <td className="sp-table-item">
                      ...
                      previous points). This can be earned in several different
                      ways, including:
                      <ul className="list-disc pl-6 md:pl-10">
            ...
            <li className="text">
              ...
              <table className="sp-table -ml-6 md:-ml-10 mt-4">
                ...
                <tbody className="sp-table-row">
                  <tr>
                    <td className="sp-table-item">
                      An acceptable thesis that addresses the global issues and
                  ...
                  <tr>
                    <td className="sp-table-item">
                      ...
                      <ul className="list-disc pl-6 md:pl-10">
                        ...
                        <li className="sp-table-list-item">
                          Provides links with relevant ideas, events, or trends
          ...
          <p className="text">
            ...
            weights of some time periods were updated, and each period was given
            a unique title. The requirements for the DBQ were further specified
            in the rubric. The MCQ was made easier by reducing the number of
          ...
          <table className="sp-table mt-4">
            ...
            <tbody className="sp-table-row">
              <tr>
                <td className="sp-table-item highlight">Global Interactions</td>
                <td className="sp-table-item">1450 - 1750</td>
                <td className="sp-table-item">20%</td>
              </tr>
            </tbody>
            ...
            <li className="text">
              ...
              <table className="sp-table -ml-6 md:-ml-10 mt-4">
                ...
                <tbody className="sp-table-row highlight">
                  <tr>
                    <td className="sp-table-item">
                      Addresses all documents and demonstrates an understanding
                      of at least all but one of the documents
                    </td>
                    <td className="sp-table-item">1</td>
                  </tr>
                </tbody>
                ...
                <tbody className="sp-table-row highlight">
                  <tr>
                    <td className="sp-table-item">
                      Groups documents in 2 or 3 different ways depending on the
                      prompt
                    </td>
                    <td className="sp-table-item">1</td>
                  </tr>
          ...
          <p className="text">
            ...
            the comparative and change-over-time essays. More time was given to
            complete the DBQ, and the number of documents was set to always be
            seven. The number of multiple choice questions was reduced to 55 and
            ...
            <li className="text">
              ...
              <table className="sp-table -ml-6 md:-ml-10 mt-4">
                ...
                <tbody className="sp-table-row highlight">
                  <tr>
                    <td className="sp-table-item">
                      ...
                      historical context, or audience is relevant to an argument
                ...
                <tbody className="sp-table-row highlight">
                  <tr>
                    <td className="sp-table-item">
                      Synthesis: Explains a connection between an argument and a
          ...
          <p className="text">
            ...
            again. The Synthesis point on the DBQ and LEQ was replaced with the
            less-specific Complexity point. The SAQ was changed to require only
            three out of the four questions to be answered, with the last two
          ...
          <p className="text">
            ...
            for a potential AP Ancient World History course that will cover
          ...
          <table className="sp-table mt-4">
            ...
            <tbody className="sp-table-row">
              <tr>
                <td className="sp-table-item">Unit 2: Networks of Exchange</td>
                <td className="sp-table-item">1200 - 1450</td>
                <td className="sp-table-item">8-10%</td>
              </tr>
            </tbody>
          ...
          <p className="text mt-6">
            Significant increases and decreases in the percentages of scores can
            be seen in the years of curriculum and exam changes, especially
            during 2011 and 2017. There was also a significant increase in the
            percentage of 1's and 2's and a decrease in the percentage of 3's
            and 4's during 2021, likely due to COVID-19. For the first time in
            the course's history, the percentage of 5's overtook the percentage
            of 1's in the most recent 2023 exam. Additionally, the exams from
            the last two years, 2022 and 2023, have had the highest average
