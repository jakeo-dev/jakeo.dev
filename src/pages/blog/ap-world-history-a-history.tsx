    ...
    <>
      ...
      <CommonHead>
        ...
        <meta
          ...
          content="As more students enroll in Advanced Placement classes, College Board is bound to make changes to..."
        />
      ...
      <div className="flex">
        <div className="flex-1">
          <div className="mt-8">
            <p className="text">
              ...
              course easier for students? I will explore the most notable
              changes that College Board has made to the AP World History
              curriculum over the past 20+ years and look at the exam data to
              determine how these changes have affected the performance of the
              test-takers.
            </p>
            ...
            <a
              ...
              target="_blank"
            >
              2002-2019, 2021-2022 Exam Data from College Board
              <FontAwesomeIcon
            ...
            <a
              ...
              target="_blank"
            >
              2020 Exam Data from College Board
              <FontAwesomeIcon
                icon={faArrowUpRightFromSquare}
                className="ml-1.5"
              />
            ...
            <a
              ...
              target="_blank"
            >
              2023 Exam Data from College Board
              <FontAwesomeIcon
                icon={faArrowUpRightFromSquare}
                className="ml-1.5"
              />
        ...
        <div className="hidden lg:block flex-[0.3] sticky top-0 self-start">
          <div className="border-l-2 border-gray-300 pb-3 pl-8 ml-10 mt-16">
            ...
            <a href="#2012" className="text link block mt-5">
              2012 Changes
            </a>
            <a href="#2017" className="text link block mt-5">
              2017 Changes
            </a>
            <a href="#2018" className="text link block mt-5">
              2018 Changes
            </a>
            <a href="#2020" className="text link block mt-5">
              2020 Changes
            </a>
            <a href="#2024" className="text link block mt-5">
              2024 Changes
            </a>
            <a href="#data" className="text link block mt-5">
              Exam Data
            </a>
            <a href="#references" className="text link block mt-5">
              References
            </a>
          </div>
        </div>
