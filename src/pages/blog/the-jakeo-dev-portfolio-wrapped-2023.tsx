    ...
    <>
      ...
      <div className="lg:flex lg:flex-row-reverse">
        ...
        <div className="flex-1">
          <Paper speed="off">
            <p className="text">
              Wraps, recaps, and replays aren't just for music streaming
              services. I can look back on 2023 too, but instead with a focus on
              my websites. Since I began this portfolio with Jorch.xyz as my
              domain in mid-2020, I've constantly added, updated, and removed
              various features from my websites. I'll look back on some of the
              biggest changes throughout the last 12 months.
            </p>
            <p className="text">
          ...
          {/* plannter */}
          <Paper speed="slow" className="sub1title w-fit" id="plannter">
            <h2>Plannter</h2>
          </Paper>

          <Paper speed="off">
            <h4 className="sub3title mt-0">January 2023</h4>
            <p className="text">
          ...
          <Paper speed="off">
            <p className="text">
              ...
              along with the addition of a tests section and the now-removed
              grade level percent difficulty calculation, which calculated the
              percentage of advanced classes out of total classes per grade
              level.
            </p>
          </Paper>
          <Paper className="post-img-div" padding="none" speed="off">
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">February 2023</h4>
            <p className="text">
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">June and July 2023</h4>
            <p className="text">
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">August 2023</h4>
            <p className="text">
          ...
          {/* cifra */}
          <Paper speed="slow" className="sub1title w-fit" id="cifra">
            <h2>Cifra</h2>
          </Paper>
          ...
          <Paper speed="off">
            ...
            <p className="text">
              ...
              own phone numbers which correspond to the letters and numbers on
              the telephone keypad of the E.161 standard.
            </p>
          </Paper>
          <Paper className="post-img-div" padding="none" speed="off">
            <Image
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">March 2023</h4>
            <p className="text">
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">July 2023</h4>
            <p className="text">
              ...
              also vast improvements to the generation; it now checks if a
              letter combination has already been attempted, and prevents the
              same number from appearing twice.
            </p>
          </Paper>
          <Paper className="post-img-div" padding="none" speed="off">
            <Image
          ...
          {/* yearn */}
          <Paper speed="slow" className="sub1title w-fit" id="yearn">
            <h2>Yearn</h2>
          </Paper>
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">October and November 2023</h4>
            <p className="text">
              Yearn's design was improved upon again in October. The abilities
              to change the color of gift items and move them around within the
          ...
          {/* decorate a tree */}
          <Paper speed="slow" className="sub1title w-fit" id="decorate-a-tree">
            <h2>Decorate a Tree</h2>
          </Paper>
          ...
          <Paper speed="off">
            ...
            <p className="text">
              ...
              update from December of 2022, with many new decor, and most
              notably a selector to choose a specific decoration item.
            </p>
          </Paper>
          <Paper className="post-img-div" padding="none" speed="off">
            <Image
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">December 2023</h4>
            <p className="text">
          ...
          <Paper speed="off">
            <p className="text">
              Below are some examples of the previous designs compared to the
              new abstract designs.
            </p>
          </Paper>
          <div className="mt-4 flex gap-x-4">
            <div>
              <Paper className="post-img-div my-0" padding="none" speed="off">
                <Image
                  ...
                  className="post-img max-w-[10rem]"
                  placeholder="blur"
                />
              </Paper>
          ...
          {/* jakeo.dev */}
          <Paper speed="slow" className="sub1title w-fit" id="jakeo-dev">
            <h2>JakeO.dev</h2>
          </Paper>
          ...
          <Paper speed="off">
            ...
            <p className="text">
              ...
              solid blue-gray bunny (compared to the newer gradient one), a
              subtle background gradient, and some of my older projects like
              Emoticon Generator and Rick Roll Roulette.
            </p>
          </Paper>
          <Paper className="post-img-div" padding="none" speed="off">
            <Image
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">June 2023</h4>
            <p className="text">
              ...
              reorganized the projects, putting only the three most recent ones
              on the home page, and then another page to view all of them. The
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">August and September 2023</h4>
            <p className="text">
              ...
              header was majorly changed. The title became a link to the home
              page, the bunny could change its color when clicked, and the
              social buttons were replaced with links to pages showing all
              Projects, Videos, and Posts. The social buttons were instead put
              in two places: next to the About Me section and in a footer.
            </p>
          </Paper>
          <Paper className="post-img-div" padding="none" speed="off">
            <Image
          ...
          <Paper speed="off">
            <h4 className="sub3title mt-0">October 2023</h4>
            <p className="text">
              ...
              of the sections were removed from their confining boxes. The
              header was modified the most, no longer being a persistent oval
              stuck to the top of the screen. The social buttons were once again
              moved to be in their own section below the About Me.
            </p>
          </Paper>
          <Paper className="post-img-div" padding="none" speed="off">
            <Image
