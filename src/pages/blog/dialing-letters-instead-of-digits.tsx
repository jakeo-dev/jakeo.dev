        ...
        <div className="flex-1">
          <Paper speed="off">
            <p className="text">
              ...
              inputted phone number as fast as possible. Over the past year and
              a half, I've found different ways to improve the efficiency and
              design of the program. It required a good understanding of how
              vanity phone numbers work and an ample amount of time to remove
              the inappropriate words from the word list that I found online.
              Even though the code may seem simple, I started with an extremely
              slow and inefficient method before finding this much faster one,
          ...
          <Paper
            ...
            id="generation-preparation"
          >
            <h2>Generation Preparation</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
            ...
            <p className="text mb-0">
              ...
              the keypad that they correspond to. In the program, these strings
              of numbers that correspond to a word* are called "numeros." Each
              numero is added to an array called numerosArray.
            </p>
            <p className="subtext">
              More than one word can share the same numero, but this won't
              affect the program.
            </p>
            <div className="code-block-div mb-0">
              <CodeBlock
                code={`numerosArray = [];
...
for (j = 0; j < wordsArray.length; j++) {
    ...
    numerosArray.push(numero);
          ...
          <div className="mt-4 mb-8 md:flex md:flex-row-reverse">
            <div className="md:ml-4">
              <Paper speed="off">
                <p className="text">
                  <span className="hidden md:inline">To the left</span>
                  <span className="md:hidden">Below</span> is the widely used
                  standard telephone keypad. A word like "call" would be
                  converted to its numero letter by letter: C to 2, A to 2, L to
                  5, and L to 5, resulting in a numero of 2255.
                </p>
                <p className="subtext">
            ...
            <Paper className="w-1/3 md:w-2/3" padding="none" speed="off">
              <img
          ...
          <div className="post-img-div">
            <Paper speed="off">
              <p className="text">
                Below is an example list of words and their corresponding
                numeros after running the code.
              </p>
            </Paper>
            <Paper className="post-img-div" padding="none" speed="off">
              <Image
          ...
          <Paper speed="slow" className="sub1title w-fit" id="match-and-form">
            <h2>Match and Form</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Step 1 (one-word vanity numbers)</h3>
          </Paper>
          <Paper speed="off" className="mb-8">
            <p className="text">
              ...
              corresponding word. Then, it will add that vanity number to an
              array called oneNumsArray.
            </p>
            <div className="code-block-div mb-0">
              <CodeBlock
    ...
    if (inp.includes(numerosArray[m])) {
        ...
        oneNumsArray.push(fixDashes(finalNumb));
              ...
              <p className="subtext">
                ...
                dashes that are at the very beginning or end of the vanity
                number so that there is only one dash between each position
                where a letter and a digit meet.
              </p>
            </div>
          </Paper>
          <Paper speed="off">
          ...
          <Paper speed="off">
            <p className="text">
              After it finishes looping through each numero, oneNumsArray will
              be filled with every possible one-word vanity number that can be
              derived from the inputted phone number.
            </p>
          </Paper>
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Step 2 (two-word vanity numbers)</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
              ...
              program by at least several tens of milliseconds and at most
              several hundred, which equates to several years from a
              programmer's perspective.
            </p>
            <p className="text">
              So, before the process is repeated, the program should do a check
              to see if it's worth it to sacrifice a little more time to attempt
              to generate more vanity numbers.
            </p>
            <ol className="text list-decimal pl-6 md:pl-10">
              <li className="text">
              ...
              <li className="text">
                ...
                correspond to any letters, so if those are the only digits left
                on all of the previously generated one-word vanity numbers,
                there's no point in trying to find another match with them,
                since there are none that exist. For example, it is impossible
                to squeeze any more words out of the one-word vanity number
                10-PLANT-010, since there are no corresponding letters for any
            ...
            <p className="text">
              ...
              longest strings of consecutive digits from 2 to 9. If that string
              in either one of them has a length greater than 2 (at least 3) and
              there is at least one one-word vanity number generated from
              before, then the program will repeat the same process from the
              previous step, but now on the list of one-word vanity numbers.
            </p>
            ...
            <p className="text">
              ...
              numero to check if any of the one-word vanity numbers contain any
              of the numeros. If it does, it will replace that numero in the
              one-word vanity number with the corresponding word. Then, it will
              add this new two-word vanity number to an array called
              twoNumsArray.
            </p>
            <div className="code-block-div">
              <CodeBlock
    ...
    for (o = 0; o < numerosArray.length; o++) {
        if (oneNumsArray[n].includes(numerosArray[o])) {
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Step 3 (three-word vanity numbers)</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
              The same checks and processes will be repeated one last time to
              add a potential third word to the vanity numbers.
            </p>
            <div className="code-block-div">
              <CodeBlock
    ...
    for (q = 0; q < numerosArray.length; q++) {
        if (twoNumsArray[p].includes(numerosArray[q])) {
          ...
          <Paper
            speed="slow"
            className="sub1title w-fit"
            id="reveal-the-numbers"
          >
            <h2>Reveal the Numbers</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
              After all of this, we now have three arrays of vanity numbers: one
              array that has numbers with one word, another that has numbers
              with two words, and the last with three words. The program will
              combine all the arrays into one and remove any duplicate vanity
              numbers. It will then display every vanity number in a
              pseudo-random order, generally showing the vanity numbers with
              more, longer words first.
            </p>
            <p className="text">
              Most ten-digit phone numbers generate all their possible vanity
              numbers in about 30 to 200 milliseconds on average. Is there a
              more efficient way to do this? Almost certainly, but for me, this
              is fast enough.
            </p>
          </Paper>

          <Paper speed="slow" className="sub1title w-fit" id="github">
            <h2>GitHub</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
