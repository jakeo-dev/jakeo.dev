    ...
    <>
      ...
      <div className="lg:flex lg:flex-row-reverse">
        ...
        <div className="flex-1">
          <Paper speed="off">
            <p className="text">
              "Congratulations" is the greatest word to begin an email,
              especially one coming from a college during decision season. The
              letter is more than an acceptance, it's also a recognition of your
              efforts. To relieve some anxiety about the future, I'll offer a
              different, more optimistic perspective on the chances of seeing
              that word from the colleges you hope to be admitted to.
            </p>
          </Paper>

          <Paper speed="slow" className="sub1title w-fit" id="background">
            <h2>Background</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Using probability for college acceptances</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Using probability for college rejections</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
              If we want to find the probability of being rejected from all
              three universities, subtract the acceptance rate from 1 to find
              the rejection rate for each one, then multiply them together.
            </p>
            <p className="text">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Using probability for the bare minimum</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
            ...
            <p className="subtext">
              ...
              probabilities because that would give a number greater than 1,
              which doesn't make sense in this case. There's probably a real
              reason for this, but I don't know or care about that...
            </p>
          </Paper>
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Using the binomial distribution</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
              If we want to find the probability of being accepted into at least
              two, at least three, or at least any number of colleges, we can
              use the binomial. Instead of showing the entire calculation, I'll
              just use the binomcdf() function on my favorite and only graphing
          ...
          <Paper speed="slow" className="sub1title w-fit" id="disclaimer">
            <h2>Disclaimer</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
              Although luck is a significant factor, acceptances are not
              entirely random chance as these calculations may suggest. These
              calculations only generalize overall acceptance rates of colleges
              into three basic categories, which isn't truly enough information
              to tell you about a person's chances of acceptance. You shouldn't
          ...
          <Paper
            ...
            id="a-mix-of-colleges"
          >
            <h2>A Mix of Colleges</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
              ...
              other half is split between the "safety" and "reach" categories.
              For this section and the rest of this post, I will use eight
              colleges in the examples. The binomial can't be used here because
              of this mix of acceptance rates.
            </p>
          ...
          <Paper speed="slow" className="sub1title w-fit" id="only-reaches">
            <h2>Only Reaches</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
              If you hate safeties and only want to apply to colleges that
              aren't easily within your range, then this is your section.
            </p>
          ...
          <Paper speed="slow" className="sub1title w-fit" id="only-ivy-league">
            <h2>Only Ivy League</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
              The Ivy League is a group of schools that are notoriously
              difficult to be accepted into. The average acceptance rate of an
              Ivy League school is extremely low: around 4.5%.
            </p>
            <h4 className="sub3title">
          ...
          <Paper speed="slow" className="sub1title w-fit" id="only-ucs">
            <h2>Only UCs</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub2title w-fit">
            <h3>Only the top four UCs (by acceptance rate)</h3>
          </Paper>
          <Paper speed="off">
            <p className="text">
              Often, some students only apply to the UCs that are the most
              difficult to be accepted into. The top half of the UCs includes
              Los Angeles, Berkeley, Irvine, and San Diego.
            </p>
            <h4 className="sub3title">
          ...
          <Paper speed="slow" className="sub1title w-fit" id="only-safeties">
            <h2>Only Safeties</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper speed="slow" className="sub1title w-fit" id="only-targets">
            <h2>Only Targets</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
          ...
          <Paper
            speed="slow"
            className="sub1title w-fit"
            id="personalized-chances"
          >
            <h2>Personalized Chances</h2>
          </Paper>
          <Paper speed="off">
            <p className="text">
              Not every college has acceptance rates around 17.5%, 55%, or
              87.5%. For more personalized chances, you should use my{" "}
              <a
