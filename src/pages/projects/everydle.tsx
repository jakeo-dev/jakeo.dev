  ...
  return (
    <>
      ...
      <div className="my-6 flex flex-col gap-3 md:flex-row">
        <Button href="https://everydle.jakeo.dev" bgColor={3}>
          Visit website
        </Button>
        <Button href="https://github.com/jakeo-dev/everydle">
          View GitHub
        </Button>
      </div>

      <Paper speed="off" pinColor={3}>
        <p className="text">
          Everydle is a website where you can play every single game of Wordle
          at the same time. I made the first version using Next.js in May 2025.
        </p>
        <p className="text">
          When{" "}
          <a
        ...
        <ul className="text list-inside list-disc">
          <li className="text">
            <a
              ...
              rel="noopener noreferrer"
            >
              "This is very funny, basically 're-type the wordle word list with
              an increasingly unuseable UI.'"
            </a>
          </li>
          <li className="text">
            <a
          ...
          <li className="text">
            <a
              ...
              rel="noopener noreferrer"
            >
              "This is HORRIBLE and made me feel slightly queasy as I tried to
