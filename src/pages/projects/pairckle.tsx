  ...
  return (
    <>
      ...
      <div className="my-6 flex flex-col gap-3 md:flex-row">
        <Button href="https://pairckle.jakeo.dev" bgColor={1}>
          Visit website
        </Button>
        <Button href="https://github.com/jakeo-dev/pairckle">
          View GitHub
        </Button>
      </div>

      <Paper speed="off" pinColor={1}>
        <p className="text">
        ...
        <p className="text">
          ...
          used to rank different cultural elements. I didn't think tier lists
          were definitive enough of a ranking, and it can be difficult to
          compare one element to every other element that was already ranked.
          Using pairwise comparisons seemed much easier and more accurate, since
          everything is being compared to everything else one at a time.
          Pairckle shows two random elements from your input, and after picking
          which one you prefer a certain number of times, it creates your
          ultimate ranking.
        </p>
      </Paper>
    </>
