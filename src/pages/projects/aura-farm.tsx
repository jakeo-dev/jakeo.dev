...
export default function AuraFarm() {
  return (
    <>
      {/* head */}
      <CommonHead>
        <title>Aura Farm | Jake Orchanian</title>
        <meta property="og:title" content="Aura Farm | Jake Orchanian" />
        <meta property="og:description" content="Explore Cal Poly while farming Aura." />
