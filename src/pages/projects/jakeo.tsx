  ...
  return (
    <>
      ...
      <Paper speed="off" pinColor={5}>
        ...
        <p className="text">
          This website first lived on the domain Jorch.xyz in September 2020,
          but I eventually switched it to JakeO.dev in December 2022.
        </p>
        <p className="text">
          The bunny you see in the header is just the Android rabbit emoji
          without any of its features. When I first added it to the website, it
          was just the emoji. Sometime in 2021, I colored it light blue, and
          later just kept the silhouette with a light-blue gradient.
        </p>
        <p className="text">
          ...
          also created a font based on my own handwriting, which I use instead
          of Lexend wherever my name is.
        </p>
      </Paper>
    </>
  );
